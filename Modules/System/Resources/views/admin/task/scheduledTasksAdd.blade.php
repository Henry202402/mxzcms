                        ...
                        <form class="form-horizontal" method="post" id="myForm">
                            ...
                            <fieldset class="content-group">
                                ...
                                @else
                                    ...
                                    <input type="hidden" name="module" value="{{$pageData['moduleInfo'][0]}}">
                                    <input type="hidden" name="module_class" value="{{$pageData['moduleInfo'][1]}}">
                                    <input type="hidden" name="module_class_method" value="{{$pageData['moduleInfo'][2]}}">
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-11">
                                        <input type="text" name="name" class="form-control"
                                               placeholder="请输入计划任务名称" value="{{$pageData['moduleInfo'][3]?:''}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-11">
                                        <input type="text" name="remark" class="form-control"
                                               placeholder="备注" value="{{$pageData['moduleInfo'][3]?:''}}">
                                    </div>
                                </div>
                                <div class="form-group">
