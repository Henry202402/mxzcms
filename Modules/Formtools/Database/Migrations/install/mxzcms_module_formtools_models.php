...
return new class extends Migration
{
  ...
  `admin_config` text COMMENT '后台配置json',
  `home_config` text COMMENT '前台配置json',
  `home_seo_config` text COMMENT '前台列表seo配置json',
  `home_seo_detail_config` text COMMENT '前台详情页SEO配置sjon',
