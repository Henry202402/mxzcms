                                                    ...
                                                    <div class="row mt-5">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="front" onclick="selectFile('file1')">
                                                                ...
                                                                <div class="img">
                                                                    <img id="file1Src"
                                                                         src="{{$data['id_card_positive_img_url']?:moduleHomeResource($moduleName,'home/assets/img/idcard-front.png')}}"
                                                                         alt="">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="behind" onclick="selectFile('file2')">
                                                                ...
                                                                <div class="img">
                                                                    <img id="file2Src"
                                                                         src="{{$data['id_card_back_img_url']?:moduleHomeResource($moduleName,'home/assets/img/idcard-behind.png')}}"
                                                                         alt="">
                                                                </div>
                                                    ...
                                                    <div class="row mt-5">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="front" onclick="selectFile('file1')">
                                                                ...
                                                                <div class="img">
                                                                    <img id="file1Src"
                                                                         src="{{$data['business_license_img_url']?:moduleHomeResource($moduleName,'home/assets/img/idcard-behind.png')}}"
                                                                         alt="">
                                                                </div>
