...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasTable("module_member_three_login")) Schema::drop('module_member_three_login');

        DB::statement("CREATE TABLE `".env("DB_PREFIX")."module_member_three_login` (
  ...
  KEY `wx_small_openid` (`wx_small_openid`)
    ...
    {
        Schema::drop('module_member_three_login');
    }
};
