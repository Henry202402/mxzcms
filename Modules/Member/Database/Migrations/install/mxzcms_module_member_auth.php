...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasTable("module_member_auth")) Schema::drop('module_member_auth');

        DB::statement("CREATE TABLE `".env("DB_PREFIX")."module_member_auth` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=".env("DB_CHARSET")." COMMENT='认证表'");
    ...
    {
        Schema::drop('module_member_auth');
    }
};
