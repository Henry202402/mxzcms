                        ...
                        <form role="form" method="post" autocomplete="off" action="{{url("admin/login/handle")}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="group-icon">
                                    <input id="exampleuser1" type="text" value="{{session("_old_input")["username"]?session("_old_input")["username"]:session("admin_remember")['username']}}"
                                           name="username" placeholder="{{getTranslateByKey("common_enter_username")}}" class="form-control" required="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="group-icon">
                                    <input id="exampleInputPassword1" name="password" type="password" value="{{session("admin_remember")['password']}}"
                                           placeholder="{{getTranslateByKey("common_enter_login_password")}}" class="form-control" required>
                            ...
                            @if(cacheGlobalSettingsByKey("admin_login_code")==1)
                                <div class="form-group">
                                    ...
                                    <div class="group-icon d-flex">
                                        ...
                                        <div class="">
                                            <img class="h-100" src="" style="cursor: pointer" onclick="this.src=''+Math.random()" />
                                        </div>
                            ...
                            <div class="clearfix">
                                <div class="float-left">
                                    <div class="checkbox checkbox-primary margin-r-5" >
                                        <input style="cursor: pointer;" id="checkbox2" type="checkbox" name="is_remember" @if(session("admin_remember")['is_remember']) checked  @endif >
                                        <label style="cursor: pointer;" for="checkbox2"> {{getTranslateByKey("login_remember_login")}} </label>
                                    </div>
                                </div>
                                <div class="float-right">
                                    <button type="submit" style="margin-top: 12px;cursor: pointer;" class="btn btn-block btn-primary btn-rounded box-shadow">{{getTranslateByKey("common_login")}}</button>
                                </div>
                            </div>
                            <hr>
