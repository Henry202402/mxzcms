                                        ...
                                        <div class="col-md-12">
                                            <ul class="comment-form-list">
                                                <li class="h-comment-form-list-item">
                                                    <input type="text" class="form-control" placeholder="当前邮箱" value="{{$userInfo['email']}}" disabled>
                                                </li>
                                                <li class="h-comment-form-list-item">
                                                    <input type="email" class="form-control" placeholder="新邮箱"
                                                           name="email" value="">
                                                    <input type="hidden" id="email_code_type" value="4">
                                                ...
                                                <li class="h-comment-form-list-item display-flex">
                                                    <input type="text" class="form-control" placeholder="邮箱验证码"
                                                           name="email_captcha" value="">
                                                    <button type="button" class="h-user-info-update-btn email_captcha_btn">
                                                        发送
                                                    </button>
                                                </li>
                                                <li class="comment-form-list-item">
                                                    <button type="button" class="btn updateUserEmailInfo">更新</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
